<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="padding-top: 100px">
            <span style="color: rgb(0, 0, 0); font-size:40px"> <b> Berkas PAD Koperasi XYZ</b></span>
    
            <iframe src="assets/pdf/Analisis Perancangan Sistem Informasi.pdf" width="100%" height="700px">
            </iframe>
        </div>
